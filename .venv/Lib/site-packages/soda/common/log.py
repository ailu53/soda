...
class Log:
    ...
    __soda_cloud_level_to_library_mappings = {v: k for k, v in __soda_cloud_level_mappings.items()}
    ...
    @classmethod
    def from_dict(cls, dict) -> Log:
        return Log(
            level=LogLevel(cls.__soda_cloud_level_to_library_mappings[dict["level"]]),
            message=dict["message"],
            location=None,  # TODO: support this if needed.
            doc=dict.get("doc"),
            exception=None,  # TODO: support this if needed.
            timestamp=datetime_from_iso_zulu(dict.get("timestamp")),
    ...
    def get_cloud_dict(self) -> dict:
        ...
        if self.location and self.location.is_fully_defined():
