...
class ADBaseModel(BaseModel):
    ...
    @classmethod
    def create_instance(cls, logger: Logs, location: Location, **kwargs: Any) -> Optional[ADBaseModel]:
        try:
            return cls(**kwargs)
...
class ProphetDynamicHyperparameters(ADBaseModel):
    ...
    @classmethod
    def metric_is_allowed(cls, v: Union[str, List[str]]) -> Union[str, List[str]]:
